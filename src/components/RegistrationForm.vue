    ...
    <form id="regForm" method="post">
      <div class="reg-form__new-user">
        ...
        <div class="main reg-form__new-user__user-info">
          <div class="main__dark-gray">
            {{ firstname }} {{ lastname }} /
            <span class="main__gray">{{ login }}</span>
          </div>
        </div>
      ...
      <div class="reg-form__sign-up">
        ...
        <div class="reg-form__sign-up__input-element">
          <div class="main main__gray label">
            Login
            <span class="main__red">*</span>
          </div>
          <br />
          <input
            @change="onRequiredFieldsChanged"
            class="main main__dark-gray reg-form__sign-up__input reg-form__sign-up__input__wide"
            type="text"
            v-model="login"
        ...
        <div class="reg-form__sign-up__input-element">
          ...
          <br />
          <input
            class="main main__dark-gray reg-form__sign-up__input reg-form__sign-up__input__narrow"
            type="text"
            v-model="firstname"
        ...
        <div class="reg-form__sign-up__input-element">
          ...
          <select
            ...
            class="main reg-form__sign-up__input reg-form__sign-up__input__select reg-form__sign-up__input__narrow"
          >
        ...
        <div class="reg-form__sign-up__input-element right-column">
          ...
          <select
            ...
            @change="onRequiredFieldsChanged"
            class="main main__dark-gray reg-form__sign-up__input reg-form__sign-up__input__select reg-form__sign-up__input__narrow"
            disabled
          >
        ...
        <div class="reg-form__sign-up__input-element">
          ...
          <br />
          <input
            class="main main__dark-gray reg-form__sign-up__input reg-form__sign-up__input__datepicker reg-form__sign-up__input__narrow"
            type="date"
            v-model="dateOfBirth"
            placeholder
          />
        ...
        <div
          class="message message__success"
          v-if="isSuccessMessageDisplayed"
        ...
        <input
          ...
          type="submit"
          class="reg-form__sign-up__button"
          value="SIGN UP"
        />
      </div>
    </form>
...
export default {
  ...
  computed: {
    isFormValid() {
      return (
        this.login && this.email && this.selectedCountry && this.selectedCity
      );
    },
    locations() {
